    ...
    public void initialise() {
        ...
        penColorButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                tempLine.setPenColor(JColorChooser.showDialog(null, "Pick Your Colour", tempLine.getPenColor()));
            }
        });
        ...
        save.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (numberOfPictures < 6) {
                    ...
                    JOptionPane.showMessageDialog(frame, "You cannot save more than 5 images in a session", "Error",
